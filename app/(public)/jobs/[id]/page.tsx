            ...
            <div className='flex flex-col lg:flex-row gap-8'>
                <div className='flex-1 border border-[#D6DDEB] p-8 space-y-3'>
                    {Array.from({ length: 6 }).map((_, i) => (
                        <div key={i} className='h-4 bg-[#F0F1F5] rounded' style={{ width: `${70 + Math.random() * 30}%` }} />
                    ))}
                </div>
        ...
        <div className='max-w-360 mx-auto px-4 lg:px-31 py-12 pb-24'>
            ...
            <div className='border border-[#D6DDEB] p-6 lg:p-10 mb-8'>
                <div className='flex flex-col sm:flex-row sm:items-center sm:justify-between gap-6'>
                    ...
                    <Link
                        ...
                        className='hidden sm:inline-block bg-brand text-white font-epilogue font-bold text-[16px] px-8 py-4 whitespace-nowrap hover:opacity-90 transition-opacity text-center'
                    >
                        Apply Now
                    </Link>
                </div>
                ...
                <div className='flex flex-wrap gap-3 mt-6 pt-6 border-t border-[#D6DDEB]'>
                    <span className='py-1 px-4 bg-[#EB85331A] text-[#FFB836] rounded-[40px] font-epilogue font-bold text-[14px]'>
                        {job.category}
                    </span>
                    <span className='py-1 px-4 bg-[#4640DE1A] text-[#4640DE] rounded-[40px] font-epilogue font-bold text-[14px]'>
                        {job.job_type}
                    </span>
                    {job.salary && (
                        <span className='py-1 px-4 bg-[#56CDAD1A] text-[#56CDAD] rounded-[40px] font-epilogue font-bold text-[14px]'>
                            {job.salary}
                        </span>
                    )}
                </div>
            ...
            <div className='flex flex-col lg:flex-row gap-8'>
                ...
                <div className='flex-1 border border-[#D6DDEB] p-6 lg:p-10'>
                    <h2 className='font-clash-display font-bold text-[24px] text-natural100 mb-6'>
                        Job Description
                    </h2>
                ...
                <div className='lg:w-80 border border-[#D6DDEB] p-6 h-fit'>
                    <h3 className='font-clash-display font-bold text-[20px] text-natural100 mb-6'>
                        Job Overview
                    </h3>
