...
const Footer = () => {
    return (
        <div className='bg-[#202430]'>
            <div className='max-w-360 mx-auto px-31 pt-16 flex flex-col'>
                ...
                <div className='flex'>
                    ...
                    <div className='ml-22.25 flex gap-23.25'>
                    ...
                    <div className='ml-17.75'>
                        ...
                        <div className="flex gap-2 items-center mt-10">
                            ...
                            <input
                                ...
                                className="pt-3 pb-3 pr-4 pl-4 text-[#A8ADB7] font-epilogue font-normal 12px 16px padding border border-none bg-white outline-none"
                            />
                ...
                <div className='flex items-center justify-between mt-10.5 mb-10.5'>

                    <p className='font-epilogue font-semibold text-[16px] text-white opacity-50'>2021 @ JobHuntly. All rights reserved.</p>
