    ...
    const cards = [
        {
            ...
            tags: [
                { bgColor: '#56CDAD1A', textColor: '#56CDAD', name: 'design' },
            ...
            <div className='mt-12'>
                ...
                >
                    {cards.map((item, index) => (
                        <div
                            key={index}
                            className='snap-start shrink-0 w-70 border border-[#D6DDEB] p-6'
                        >
                            ...
                            <div className='mt-4'>
                                ...
                                <div className='mt-4 flex gap-2'>
                                    {item.tags.map((tags, index) => (
                                        <button key={index} className={`py-1 px-4 bg-[${tags.bgColor}] text-[${tags.textColor}] rounded-[40px] font-epilogue font-bold text-[16px] capitalize`}>
                                            {tags.name}
                                        </button>
                                    ))}
                                </div>
                ...
                <button className='lg:hidden cursor-pointer mt-6 text-[#4640DE] font-epilogue text-[16px] font-bold flex items-center gap-2'>
                    Show all jobs
                    <svg xmlns="http://www.w3.org/2000/svg" className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                    </svg>
