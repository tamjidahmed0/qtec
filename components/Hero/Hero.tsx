...
const Hero = () => {
    return (
        ...
        >
            <div className='pt-2.25 px-31 flex gap-14.5 max-w-360 mx-auto'>


                <div className='w-157.25 pt-18.25'>
                    <div className='w-133.25'>
                        <h1 className='font-clash-display text-[72px] leading-[110%] text-natural100'>
                            Discover more than <span className='text-accents-blue'>5000+ Jobs</span>
                        </h1>
                        <Image src={Vector} alt='vector' className='mt-3.25' />
                    </div>
                    <p className='mt-[30.41px] font-epilogue font-light text-[20px] leading-[160%] w-130.25 text-natural'>
                        Great platform for the job seeker that searching for new career heights and passionate about startups.
                    </p>


                    <div className='mt-5.75 px-4 py-4 relative z-50 flex items-center bg-white rounded-sm shadow-sm border border-[#D6DDEB] w-213'>

                        {/* Job title input */}
                        <div className='flex items-center gap-3  flex-1  border-[#D6DDEB]  '>
                        ...
                        {/* Search button */}
                        <button className='bg-brand text-white font-epilogue font-bold text-[16px] px-6.75 py-3.5 h-full whitespace-nowrap cursor-pointer'>
                            Search my job
                        </button>
